<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasExampleLabel">TaxiSûr</h5>
                        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div>
                    <div class="offcanvas-body">
                        <div>
                            Bienvenue sur votre espace admin. Merci de vous deconnecter avant de quitter votre espace administrateur.
                        </div>
                        <br>
        ...
        <div class="copyright-w3-agile fixed-bottom">
            <p>&copy; 2023 <a href="/welcome">TaxiSûr-App</a>. All rights reserved | Design by Guy Dorveil! </p>
        </div>
